...
locale_keys! {
    ...
    // Tauri desktop shell — tray / window surfaces
...
/// V1 desktop locale keys shared with the React WebView.
///
/// Keep this list in sync with `ALL_LOCALE_KEYS` in
/// `apps/desktop-tauri/src/i18n/keys.ts`; `pnpm run check-locale` verifies
/// the drift automatically.
pub const V1_LOCALE_KEYS: &[&str] = &[
    "app.name",
    "usage.fiveHours",
    "usage.weekly",
    "usage.remaining",
